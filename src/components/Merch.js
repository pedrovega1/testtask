      ...
      <div className="flex flex-col lg:flex-row justify-between w-full items-center px-4 py-10 lg:py-20" id="MerchRoot">
        <div className="flex flex-col gap-4 sm:w-full md:w-1/2 lg:w-1/2 items-center sm:items-start">
          ...
          <div className="self-stretch flex flex-row justify-between items-center">
            <div className="text-lg font-['Inter'] tracking-[1.26] leading-[27.8px] text-white w-2/3 md:w-1/2">
              BLACK "DRIFTING" HOODIE
            </div>
            <div className="text-lg font-['Inter'] font-bold tracking-[1.26] leading-[27.8px] text-white self-end">
              $ 50.00
            </div>
          </div>
        </div>
